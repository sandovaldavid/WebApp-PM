...
class IntegracionJira(models.Model):
    ...
    importar_issues = models.BooleanField(default=True, 
        help_text="Si está activo, importa issues desde Jira")
    exportar_tareas = models.BooleanField(default=True,
        help_text="Si está activo, exporta tareas locales a Jira")
    sync_comentarios = models.BooleanField(default=True,
        help_text="Si está activo, sincroniza comentarios")
    sincronizar_adjuntos = models.BooleanField(default=False,
        help_text="Si está activo, sincroniza archivos adjuntos")
