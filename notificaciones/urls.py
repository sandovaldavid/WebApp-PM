...
urlpatterns = [
    ...
    # Notificaciones
    path(
        "notificaciones/lista/", views.lista_notificaciones, name="lista_notificaciones"
    ),
    path("notificaciones/crear/", views.crear_notificacion, name="crear_notificacion"),
    path(
        "notificaciones/<int:id>/detalle/",
        views.detalle_notificacion,
        name="detalle_notificacion",
    ),
    path(
        "notificaciones/<int:id>/marcar_leida/",
        views.marcar_notificacion,
        name="marcar_leida",
    ),
    path(
        "notificaciones/<int:id>/archivar/",
        views.archivar_notificacion,
        name="archivar_notificacion",
    ),
    path(
        "notificaciones/<int:id>/eliminar/",
    ...
    path(
        "alertas/vista_previa/", views.vista_previa_alerta, name="vista_previa_alerta"
    ),
    path("alertas/generar/", views.generar_alertas, name="generar_alertas"),
    path(
        "alertas/estadisticas/", views.estadisticas_alertas, name="estadisticas_alertas"
    ),
]
