...
def registro_actividades(request):
    ...
    datos_actividades_usuario = {
        ...
        "data": [
            Actividad.objects.filter(idusuario=usuario).count()
...
def crear_actividad(request):
    ...
    if request.method == "POST":
        ...
        form = ActividadForm()
    return render(
        request, "auditoria/crear_actividad.html", {"form": form, "usuarios": usuarios}
    )
...
def editar_actividad(request, id):
    ...
    return render(
        ...
        {"form": form, "actividad": actividad, "usuarios": usuarios},
    )
