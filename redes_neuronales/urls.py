...
urlpatterns = [
    ...
    path(
        "generar-informe-evaluacion/",
        views.generar_informe_evaluacion,
        name="generar_informe_evaluacion",
    ),
    path(
        "check-active-training/",
        views.check_active_training,
        name="check_active_training",
    ),
    # Endpoints de diagnóstico y estado
    path(
        "diagnosticar-entrenamiento/",
        views.diagnosticar_entrenamiento,
        name="diagnosticar_entrenamiento",
    ),
