...
def retrain_model():
    ...
    try:
        ...
        if df is None or len(df) < 10:
            logger.warning("Datos insuficientes para reentrenar. Se necesitan al menos 10 registros.")
            return False
        ...
        logger.info(f"Métricas: R² = {metrics.get('r2', 'N/A')}, MAE = {metrics.get('mae', 'N/A')}")
        return True
