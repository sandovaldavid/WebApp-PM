...
class DataProcessor:
    ...
    def get_db_categories(self):
        ...
        try:
            ...
            if not tipos_tarea:
                tipos_tarea = ['Frontend', 'Backend', 'Database', 'Testing', 'Arquitectura']
            if not fases:
                fases = ['Inicio/Conceptualización', 'Elaboración/Requisitos', 
    ...
    def preprocess_data(self, test_size=0.2, val_size=0.15):
        ...
        if hasattr(self, 'data') and self.data is not None:
            ...
            if val_size <= 0:
                ...
                test_ratio_in_temp = (
                    min(0.999, test_size / total_size) if total_size > 0 else 0.5
                )
    ...
    def process_single_task(self, task_data):
        ...
        if not hasattr(self, 'scalers') or not hasattr(self, 'encoders'):
            raise ValueError("Preprocessors no cargados. Ejecute load_preprocessors primero.")
