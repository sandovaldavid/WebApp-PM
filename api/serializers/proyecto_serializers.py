...
class ProyectoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Proyecto
        fields = [
            'idproyecto', 'nombreproyecto', 'descripcion', 'idequipo',
            'fechainicio', 'fechafin', 'presupuesto', 'presupuestoutilizado',
...
class ProyectoListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Proyecto
        fields = [
            'idproyecto', 'nombreproyecto', 'estado', 
            'fechainicio', 'fechafin', 'equipo_nombre'
        ]
