...
from api.serializers.proyecto_serializers import ProyectoSerializer, ProyectoListSerializer
...
class ProyectoViewSet(viewsets.ModelViewSet):
    ...
    def equipo(self, request, pk=None):
        ...
        if not equipo:
            return Response({"detail": "Este proyecto no tiene un equipo asignado."}, 
