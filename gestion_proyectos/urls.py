...
urlpatterns = [
    ...
    path('eliminar-proyecto/<int:idproyecto>/', views.eliminar_proyecto, name='eliminar_proyecto'),
    ...
    path('crear-requerimiento/<int:idproyecto>/', views.crear_requerimiento, name='crear_requerimiento'),  # Nueva ruta
